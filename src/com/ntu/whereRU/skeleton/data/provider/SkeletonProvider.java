...
import com.ntu.whereRU.app.config.LogConfig;
...
public class SkeletonProvider extends ContentProvider {
	...
	private static final String LOG_TAG = SkeletonProvider.class
			.getSimpleName();
	...
	public static final String AUTHORITY = "com.ntu.whereru.data.provider.skeletonprovider";

	public static final Uri INTEGRITY_CHECK_URI = Uri.parse("content://"
			+ AUTHORITY + "/integrityCheck");
	...
	private static final String[] TABLE_NAMES = { Skeleton.TABLE_NAME };
	...
	static SQLiteDatabase getReadableDatabase(final Context context) {
		final DatabaseHelper helper = new SkeletonProvider().new DatabaseHelper(
	...
	public int bulkInsert(final Uri uri, final ContentValues[] values) {
		...
		try {
			...
			case SKELETON:
				insertStmt = db
						.compileStatement(Skeleton.getBulkInsertString());
